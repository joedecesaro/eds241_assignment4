...
\noindent For every 1 m/s increase in wind speed there is a `r round(fs1$coefficient[[2]], 3)` increase in the log price of fish. This is the expected sign as more wind means it would be harder for boats to get fresh fish so supply goes down.
